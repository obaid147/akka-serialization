...
object KryoSerialization_Local extends App {
    ...
    actorSelection ! Book("The JVM Experience", 2022)
}
...
object KryoSerialization_Persistence extends App {
    ...
    val simplePersistentActor = system.actorOf(SimplePersistentActor.props("kryo-actor"),
        "kryoBookActor")

    //simplePersistentActor ! Book("The JVM Experience", 2022)
}